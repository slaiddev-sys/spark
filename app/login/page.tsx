  ...
  return (
    <main className="min-h-screen bg-nuvix-dark relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12">
        ...
        {/* Message */}
        {message && (
          <div className="mb-4 p-3 rounded-xl bg-red-900/20 text-red-400">
            {message}
          </div>
        )}
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="/forgot-password" className="text-[#0061e8] hover:text-[#0051c8]">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          ...
          <Link href="/signup" className="text-[#0061e8] hover:text-[#0051c8] font-medium">
            Sign up
          </Link>
        </p>
      </div>
